...
[AV1](https://codecs.wiki/docs/video/AV1) is a royalty-free video codec developed by the Alliance for Open Media. It is designed to replace [VP9](https://codecs.wiki/docs/video/VP9) and presently competes with [H.266](https://codecs.wiki/docs/video/VVC). AV1 is known for its high compression efficiency, which the marketing will have you believe reduces file sizes by up to 50% compared to [H.264](https://codecs.wiki/docs/video/AVC) and up to 30% compared to [H.265](https://codecs.wiki/docs/video/HEVC) across the board. It is supported by several major browsers and is widely used across many streaming services and video platforms.
...
The enumeration above still consists of broad strokes, but the point is to understand that AV1 is not a silver bullet. It will not automatically make your videos smaller while preserving your desired quality. To make things more difficult, the [x264](https://codecs.wiki/docs/encoders/x264) & [x265](https://codecs.wiki/docs/encoders/x265) encoders are very mature, while AV1 encoding efforts designed to meet the extremely complicated needs of the human eye are still in their infancy.
...
- **Don't** blindly trust metric scores. It is unfortunate how trusted [VMAF](https://codecs.wiki/docs/metrics/VMAF) is considering how infrequently it correlates with visual fidelity in practice now that it has become so popular. Even the beloved [SSIMULACRA2](https://codecs.wiki/docs/metrics/SSIMULACRA2) is not a perfect one-to-one with the human eye.
...
Here's the key:
- **Encoder(s)**: The AV1 encoder(s) the software uses or is able to use. This is between [SVT-AV1](https://codecs.wiki/docs/encoders/SVT-AV1), [aomenc](https://codecs.wiki/docs/encoders/aomenc), [rav1e](https://codecs.wiki/docs/encoders/rav1e), [SVT-AV1-PSY](https://codecs.wiki/docs/encoders/SVT-AV1-PSY), and various aomenc forks. We'll get into this more later.
...
|---------|-------------|:----------:|:-----------:|:-----------:|------------|
| [Aviator](https://codecs.wiki/docs/utilities/Aviator) | Linux       | SVT-AV1-PSY| ●●●●●       | ●○○○○         | ●●●●●     |
| [NMKODER](https://codecs.wiki/docs/utilities/nmkoder) | Windows     | Any        | ●●●○○       | ●●●●○         | ●●○○○     |
...
| [rAV1ator](https://codecs.wiki/docs/utilities/rav1ator)  | Linux     | rav1e       | ●●●●○      | ●●●○○         | ●○○○○     |
...
| [FFmpeg](https://codecs.wiki/docs/utilities/ffmpeg) | Itself | ●●○○○ | ●●●●● | ●●●●○ | No |
| [Av1an](https://codecs.wiki/docs/utilities/av1an) | FFmpeg | ●○○○○ | ●●●●● | ●●●○○ | Yes |
| [rAV1ator CLI](https://codecs.wiki/docs/utilities/rav1ator-cli) | Av1an | ●●●●○ | ●●●●○ | ●●●●○ | Yes |
...
[SVT-AV1](https://codecs.wiki/docs/encoders/SVT-AV1) (Scalable Video Technology for AV1) is an AV1 encoder library and application developed by Intel, Netflix, and others. It has gained significant popularity in the encoding community due to its impressive balance of speed, quality, and scalability.

Links:
- Wiki page: [SVT-AV1](https://codecs.wiki/docs/encoders/SVT-AV1)
...
[rav1e](https://codecs.wiki/docs/encoders/rav1e) is an AV1 encoder written in Rust & Assembly. Developed by the open-source community alongside Xiph, it brings a unique approach to AV1 encoding with its focus on safety and correctness.

Links:
- Wiki page: [rav1e](https://codecs.wiki/docs/encoders/rav1e)
...
[aomenc](https://codecs.wiki/docs/encoders/aomenc), based on the libaom library, is the reference encoder for AV1. Developed by the Alliance for Open Media (AOM), it is the benchmark for AV1 encoding quality and compliance.

Links:
- Wiki page: [aomenc](https://codecs.wiki/docs/encoders/aomenc)
...
[SVT-AV1-PSY](https://codecs.wiki/docs/encoders/svt-av1-psy) is a community fork of the SVT-AV1 encoder focused on psychovisual optimizations to enhance perceived visual quality. It aims at closing the distance between SVT-AV1's high speeds and the perceptual quality of aomenc's slow brute force approach.

Links:
- Wiki page: [SVT-AV1-PSY](https://codecs.wiki/docs/encoders/svt-av1-psy)

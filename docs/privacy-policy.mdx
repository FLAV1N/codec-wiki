...
- Analytics data is not shared explicitly with advertising companies or any other companies in general. It is made available to everyone, for free, on our [analytics page](https://analytics.x266.mov/codecs.wiki/)
- Analytics data isn't explicitly sent to any third parties
- Analytics data is not monetized

As a wiki dedicated to making multimedia codec knowledge more accessible, analytics information is made public via our [analytics page](https://analytics.x266.mov/codecs.wiki/).

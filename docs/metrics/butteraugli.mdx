...
most people will want to use the [HIP/CUDA implementation `vship`](https://codeberg.org/Line-fr/Vship).  
...
The [Release page](https://codeberg.org/Line-fr/Vship/releases) of the repository provides up-to-date binaries for Windows users.

<Tabs>
    <TabItem value="compiling" label="Compiling" default>
        To compile Vship, follow the [instructions](https://codeberg.org/Line-fr/Vship#installation) on the repository.
    </TabItem>

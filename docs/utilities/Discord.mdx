...
The key has a number of emojis corresponding to full support, partial support, support with the [Discord embed workaround](https://codecs.wiki/blog/embedding-the-un-embeddable), and no support.
